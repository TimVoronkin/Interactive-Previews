...
\long\def\textPodekovani{%
	...
	Zvláštní, hluboký dík patří mé mamince~-- člověku, který ve mě věřil za všech okolností, od dětství mě učil nevzdávat se a~důvěřovat vlastní cestě. Je mi nesmírně líto, že se nedočká mé promoce ani dalšího dospívání po mém boku. \textit{Světlá  vzpomínka.}
}
% ANOTACE
\long\def\anotace{%
